...
def deleteNoise(tokenList):
    ...
    # delete noise, in terms of append the words that are not in the noiseList to a new list
    ...
    cleanContent = cleanContent.replace('spkeaks', 'spkeak')
    ...
    cleanContent = cleanContent.replace('republicans', 'replublican')
    ...
    cleanContent = cleanContent.replace('trends', 'treand')
    cleanContent = cleanContent.replace('costs', 'cost')
    cleanContent = cleanContent.replace('americans', 'american')
    cleanContent = cleanContent.replace('oppotunities', 'opputunity')
...
def main():
    # read text from user and perform preliminary cleaning
    tokenList = read()
    # remove noise and perform scrubing
